...
namespace AuctionService.UnitTests
{
    public class AuctionControllerTests
    {
        ...
        [Fact]
        public async Task GetAuctions_WithNoParams_Returs10Auctions()
        {
            // Arrange
        ...
        [Fact]
        public async Task GetAuctionById_WithValidGuid_RetursAuction()
        {
            // Arrange
        ...
        [Fact]
        public async Task GetAuctionById_WithInvalidGuid_RetursNotFound()
        {
            // Arrange
        ...
        [Fact]
        public async Task CreateAuctio_WithValidCreateAuctionDto_RetursCreatedAtAction()
        { 
            // Arrange
